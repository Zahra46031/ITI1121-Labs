...
public class PlayList {
    ...
    public static PlayList getSongsFromFile( String fileName ) throws IOException {
         ...
         PlayList newlst = new PlayList(capacity);
         File file1 = new File(fileName);
         BufferedReader reader1 = new BufferedReader(new InputStreamReader(new FileInputStream(file1)));
         BufferedReader reader2 = new BufferedReader(new InputStreamReader(new FileInputStream(file1)));
         while(reader2.readLine() != null){
             String[] newline = reader1.readLine().split(":");
             Song newSong = new Song(newline[0], newline[1], newline[2]);
             newlst.addSong(newSong);
